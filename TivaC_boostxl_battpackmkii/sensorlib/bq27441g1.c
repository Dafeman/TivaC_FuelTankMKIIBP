...
void
BQ27441G1DataAtRateTimeToEmptyGetRaw(tBQ27441G1 *psInst, int16_t *pi16Data)
{
    //
    // Return the raw data value.
    //
...
/* API for BQ27510G3 Fuel Gauge.
void
BQ27441G1DataAtRateTimeToEmptyGetFloat(tBQ27441G1 *psInst, float *pfData)
{
    int16_t i16Data;
    ...
    // Get the raw readings.
    //
    BQ27441G1DataAtRateTimeToEmptyGetRaw(psInst, &i16Data);
...
/* API for BQ27510G3 Fuel Gauge.
void
BQ27441G1DataTimeToEmptyGetRaw(tBQ27441G1 *psInst, int16_t *pi16Data)
{
    //
    // Return the raw data value.
    //
...
/* API for BQ27510G3 Fuel Gauge.
void
BQ27441G1DataTimeToEmptyGetFloat(tBQ27441G1 *psInst, float *pfData)
{
    int16_t i16Data;
    ...
    // Get the raw readings.
    //
    BQ27441G1DataTimeToEmptyGetRaw(psInst, &i16Data);
...
/* API for BQ27510G3 Fuel Gauge.
void
BQ27441G1DataTimeToEmptyStandbyGetRaw(tBQ27441G1 *psInst, int16_t *pi16Data)
{
    //
    // Return the raw data value.
    //
...
/* API for BQ27510G3 Fuel Gauge.
void
BQ27441G1DataTimeToEmptyStandbyGetFloat(tBQ27441G1 *psInst, float *pfData)
{
    int16_t i16Data;
    ...
    // Get the raw readings.
    //
    BQ27441G1DataTimeToEmptyStandbyGetRaw(psInst, &i16Data);
...
/* API for BQ27510G3 Fuel Gauge.
void
BQ27441G1DataCycleCountGetRaw(tBQ27441G1 *psInst, int16_t *pi16Data)
{
    //
    // Return the raw data value.
    //
...
/* API for BQ27510G3 Fuel Gauge.
void
BQ27441G1DataCycleCountGetFloat(tBQ27441G1 *psInst, float *pfData)
{
    int16_t i16Data;
    ...
    // Get the raw readings.
    //
    BQ27441G1DataCycleCountGetRaw(psInst, &i16Data);
...
/* API for BQ27510G3 Fuel Gauge.
void
BQ27441G1DataCurrentInstantaneousGetRaw(tBQ27441G1 *psInst, int16_t *pi16Data)
{
    //
    // Return the raw data value.
    //
...
/* API for BQ27510G3 Fuel Gauge.
void
BQ27441G1DataCurrentInstantaneousGetFloat(tBQ27441G1 *psInst, float *pfData)
{
    int16_t i16Data;
    ...
    // Get the raw readings.
    //
    BQ27441G1DataCurrentInstantaneousGetRaw(psInst, &i16Data);
